...
public class ProducerTest extends Assert {
    ...
    public void test() {
        Producer p = new Producer(new Jedis("localhost"), "foo");
        Consumer c1 = new Consumer(new Jedis("localhost"), "a subscriber1", "foo");
        Consumer c2 = new Consumer(new Jedis("localhost"), "a subscriber2", "foo");

        p.publish("hello 1");
        p.publish("hello 2");
        p.publish("hello 3");
        System.out.println(c1.consume());
        System.out.println(c1.consume());
        System.out.println(c1.consume());
    }
